(function () {
    ...
    class Datetime$1 {
        ...
        useLocale(val){
            this.locale = !isset(Datetime$1.locales[val], false) ? "en" : val;
...
[^' + nonCharacter + generalPunctuationBlock + whitespace + ']+', 'g');
    ...
    * */
    ...
    const Contains = {
        ...
        eq(i){
            return !undef$1(i) && this.length > 0 ? $(this.get(i), undefined,{prevObj: this}) : this
        },
    ...
    const Css = {
        ...
        removeStyle: function(name){
            if (undef$1(name) || this.length === 0) return this
    ...
    const Visibility = {
        inViewport(){
            return this.length ? inViewport$1(this[0]) : undefined
        },
    ...
    const Size = {
        ...
        _sizeOut: function(prop, val){
            ...
            if (!undef$1(val) && typeof val !== "boolean") {
                return this.each((_, el) => {
                    if (el === window || el === document) {return }
    ...
    function required (val, name, context) {
    ...
    const undef = val => typeof val === "undefined" || val === null;
