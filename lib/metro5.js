    ...
    * */
    ...
    class Dropdown extends Component {
        ...
        open(el){
            ...
            exec$1(dropdown.options.onDropdown, [dropdown]);
    ...
    class Tabs extends Component {
...

            {
                ...
                serviceContainer.append(
                    $("<div>").addClass("tabs__service-button").html(`
                        ...
                        <ul class="dropdown-menu tabs__invisible_tab_holder">
                            <li><a href="">Item</a></li>                    
                        </ul>
                    `)
                );
                console.log(Metro5);
                Metro5.makePlugin(serviceContainer.find(".tabs__invisible_tab_holder")[0], "dropdown", {
                    onDropdown: el => {
        ...
        createEvents(){
            ...
            element.on("click", ".tabs__item__add-tab", (e)=>{
                ...
                exec$1(o.onTabAppend, [element[0]]);
            });
        }
