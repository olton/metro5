...
[^' + nonCharacter + generalPunctuationBlock + whitespace + ']+', 'g');
    ...
    * */
    ...
    function required$1 (val, name, context) {
    ...
    class Counter extends Component {
        ...
        createEvents(){
            ...
            $(window).on("scroll", () => {
                if (o.startOnViewport === true && inViewport$1(element[0]) && !this.started) {
                    this.run();
                }
            }, {ns: this.id});
        }
        ...
        run(){
            ...
            if (!inViewport$1(this.elem) || this.started) return
    ...
    class Form$1 extends Component {
        constructor(elem, options) {
